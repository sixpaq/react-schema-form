...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Form = function (_React$Component) {
	  ...
	  function Form(props, context) {
	    ...
	    _this.renderSchema = _this.renderSchema.bind(_this);
	    _this.onChange = _this.onChange.bind(_this);
	    _this.touchSchema = _this.touchSchema.bind(_this);
	    _this.state = (0, _lodash.extend)({
	      data: props.data || {},
	      errors: {}
	    }, props.controls || {});

	    _this.components = {
	      Label: _defaults.DefaultLabel,
	      Title: _defaults.DefaultTitle,
	      Error: _defaults.DefaultError,
	      controls: {
	        'string': _string2.default
	      }
	    };
	    if (props.components) {
	      _this.components = (0, _lodash.extend)(_this.components, props.components);
	    }
	  ...
	  _createClass(Form, [{
	    ...
	    value: function hasErrors() {
	      var count = 0;
	      Object.values(this.state.errors || {}).forEach(function (error) {
	    ...
	    key: 'touchSchema',
	    value: function touchSchema() {
	      var schema = this.props.schema;


	      var touchProperties = function touchProperties(properties) {
	        if (properties instanceof Array) {
	          properties.forEach(function (p) {
	            return touchProperties(p);
	          });
	          return;
	        }
	    ...
	    key: 'validateField',
	    value: function validateField(field, value, emit) {
	      var errors = [];
	      ...
	      if (typeof field.validation === 'function') {
	        ...
	        if (v && v.length) v.map(function (e) {
	          return errors.push(e);
	        });
	      }

	      var state = this.state || {};
	      if (!(0, _lodash.isEqual)(field.errors, errors)) {
	        field.errors = errors;
	      ...
	      var validateProperties = function validateProperties(properties) {
	        ...
	        Object.keys(properties).forEach(function (p) {
	          ...
	          if (o && o.properties) {
	            ...
	            var value = (0, _lodash.get)(_this2.state.data, o.id);
	            _this2.validateField(o, value, true);
	          }
	        });
	      };
	    ...
	    key: 'onChange',
	    value: function onChange(id, field, event) {
	      var state = this.state || {};
	      (0, _lodash.set)(state.data, field.id, event.target.value);
	    ...
	    key: 'renderField',
	    value: function renderField(id, field) {
	      var value = (0, _lodash.get)(this.state.data, field.id);
	    ...
	    value: function renderProperties(id, properties, schema) {
	      var _this3 = this;

	      if (properties instanceof Array) {
	        return properties.map(function (p, i) {
	          return _this3.renderProperties(id + '.' + i, p, schema);
	        });
	      }
	      var fields = [];
	      Object.keys(properties).forEach(function (p, index) {
	        var o = properties[p];
	        if (o.properties) {
	          o.level = schema.level + 1;
	          fields.push(_this3.renderSchema(id + '.' + p, o, index));
	        } else {
	          fields.push(_this3.renderField(id + '.' + p, o, index));
	        }
	      });
	      return _react2.default.createElement('div', { key: 'prop.' + id, className: 'form-row' }, fields);
	    }
	  }, {
	    key: 'renderSchema',
	    value: function renderSchema(id, schema, index) {
	      var Title = this.components.Title || _defaults.DefaultTitle;
	      return _react2.default.createElement(
	        'div',
	        { key: 'schema.' + id, className: 'form-block' },
	        _react2.default.createElement(Title, { level: schema.level, title: schema.title }),
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement('form', { onSubmit: function onSubmit(e) {
	          e.preventDefault();_this4.onSubmit();
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var DefaultLabel = exports.DefaultLabel = function DefaultLabel(props) {
	  return React.createElement('label', { className: 'control-label' }, props.title || props.id);
	};

	var DefaultTitle = exports.DefaultTitle = function DefaultTitle(_ref2) {
	  var level = _ref2.level,
	      title = _ref2.title;

	  if (level === 1) return null;
	  var h = React.createElement('h3', {}, title);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var StringControl = function StringControl(_ref) {
	  var name = _ref.name,
	      value = _ref.value,
	...
	var Field = function (_React$Component) {
	  ...
	  _createClass(Field, [{
	    ...
	    value: function render() {
	      ...
	      if (!(0, _lodash.get)(field, 'options.noLabel')) {
	        var Label = (components || {}).Label || _defaults.DefaultLabel;
	      ...
	      if (field.control && components.controls[field.control]) {
	        content = _react2.default.createElement(components.controls[field.control], {
	          key: 'control',
	          type: 'text',
	          name: field.id,
	        ...
	        content = _react2.default.createElement('input', attributes);
	      }

	      var untouched = this.state.untouched && field.untouched;

	      var errors = null;
	      if (!untouched && field.errors && field.errors.length) {
	        var _Error = (components || {}).Error || _defaults.DefaultError;
	        errors = field.errors.map(function (error, i) {
	          return _react2.default.createElement(_Error, { key: i, error: error });
	        });
	      }
	      ...
	      return _react2.default.createElement(components.Field || 'div', { className: classes.join(' ') }, [label, content, errors]);
	    }
	  }]);
